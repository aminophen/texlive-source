...
*/
#if defined(_WIN32)
#if defined(pdfTeX) || defined(upTeX) || defined(eupTeX) || defined(zpTeX) || defined(XeTeX)
...

#if defined(pdfTeX) || defined(epTeX) || defined(eupTeX) || defined(zpTeX) || defined(XeTeX)
/*
...

/* pdfTeX routines also used for e-pTeX, e-upTeX, zpTeX, and XeTeX */
#if defined (pdfTeX) || defined (epTeX) || defined (eupTeX) || defined(zpTeX)|| defined(XeTeX)
