...
#include "uptexdir/kanji.h"
#elif defined (zpTeX)
#define TEXMFPOOLNAME "zptex.pool"
#define TEXMFENGINENAME "zptex"
#include "uptexdir/kanji.h"
#else
...
/* pdfTeX routines also used for e-pTeX, zpTeX, and XeTeX */
...
#if defined(pTeX) || defined(epTeX) || defined(upTeX) || defined(eupTeX) || defined(zpTeX)
